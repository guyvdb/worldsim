...
namespace graph {
   ...
   *
   * --------------------------------------------------------------------------------------*/
  txid TransactionLog::FrameStart(){
   ...
   *
   * --------------------------------------------------------------------------------------*/
  bool TransactionLog::FrameAppend(gid id, Storeable::Concept concept, TransactionOp op, ByteBuffer *buffer){
 ...
 // }
   ...
   * --------------------------------------------------------------------------------------*/
  bool TransactionLog::LastTransactionNumber(txid *result) {
