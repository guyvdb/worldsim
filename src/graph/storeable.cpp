...
namespace graph {
   ...
   * --------------------------------------------------------------------------------------*/
  Storeable::Storeable(type::gid id, ByteBuffer *buffer) : m_graphid(id), m_buffer(buffer), m_transaction(0x0), m_dirty(false) {
  }
   ...
   *
   * --------------------------------------------------------------------------------------*/
  tx::Transaction* Storeable::GetTransaction() {
   ...
   *
   * --------------------------------------------------------------------------------------*/
  void Storeable::SetTransaction(tx::Transaction *tx) {
   ...
   *
   * --------------------------------------------------------------------------------------*/
  StoreableWithType::StoreableWithType(type::gid id, std::size_t size) : Storeable(id, size) {
   ...
   *
   * --------------------------------------------------------------------------------------*/
  StoreableWithType::StoreableWithType(type::gid id, ByteBuffer *buffer) : Storeable(id, buffer) {
   ...
   *
   * --------------------------------------------------------------------------------------*/
  type::gid StoreableWithType::GetTypeId(){
   ...
   *
   * --------------------------------------------------------------------------------------*/
  void StoreableWithType::SetTypeId(type::gid type) {
   ...
   *
   * --------------------------------------------------------------------------------------*/
  StoreableWithAttributes::StoreableWithAttributes(type::gid id, std::size_t size) : StoreableWithType(id, size) {
   ...
   *
   * --------------------------------------------------------------------------------------*/
  StoreableWithAttributes::StoreableWithAttributes(type::gid id, ByteBuffer *buffer) : StoreableWithType(id,buffer) {
