...
namespace graph {
  ...
  namespace tx {
    ...
    class FrameRecord {
      public:
        FrameRecord(type::gid id, Storeable::Concept concept, TransactionOp op, ByteBuffer *buffer) : m_id(id), m_concept(concept), m_op(op), m_buffer(buffer) {}
    ...
    class TransactionLog {
      public:
        ...
        bool FrameAppend(type::gid id, Storeable::Concept type, TransactionOp op, ByteBuffer *buffer);
        bool FrameEnd();
      private:
